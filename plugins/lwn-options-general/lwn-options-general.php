			...
			<div class="wrap">
                ...
                <tr>
										<th class="row">
										 ...
										 <td>
                          <input type="text" id="lwn_option_name" name="lwn_option_name" class="regular-text" required>
                     </td>
								</tr>
                <tr>
										<th class="row">
										 ...
										 <td>
                          <input type="text" id="lwn_option_value" name="lwn_option_value" class="regular-text" required>
                     </td>
								</tr>
                <tr>
